...
# Canonical pass order. Later passes must see earlier passes' writes, so the
# order is part of the contract, not just an iteration detail.
ALL_MODES = (
...
def mode_configs(
    ...
    *,
    ...
    modes: tuple[configs.MlaCase, ...] = ALL_MODES,
